...
func TestSplitProcessCommandForOS_WindowsKeepsBackslashes(t *testing.T) {
	cases := []struct {
		...
		{
			name:  "unquoted temp path",
			input: `C:\Users\RUNNER~1\AppData\Local\Temp\external_test\sts_script.bat`,
			want:  []string{`C:\Users\RUNNER~1\AppData\Local\Temp\external_test\sts_script.bat`},
		},
		{
